...
function findWasmBinary() {
  return locateFile('hitthetarget.wasm');
}
...
var ASM_CONSTS = {
  110616: () => { if (document.fullscreenElement) return 1; },  
 110662: () => { return document.getElementById('canvas').width; },  
 110714: () => { return parseInt(document.getElementById('canvas').style.width); },  
 110782: () => { document.exitFullscreen(); },  
 110809: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 110882: () => { if (document.fullscreenElement) return 1; },  
 110928: () => { return document.getElementById('canvas').width; },  
 110980: () => { return screen.width; },  
 111005: () => { document.exitFullscreen(); },  
 111032: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 111165: () => { return window.innerWidth; },  
 111191: () => { return window.innerHeight; },  
 111218: () => { if (document.fullscreenElement) return 1; },  
 111264: () => { return document.getElementById('canvas').width; },  
 111316: () => { return parseInt(document.getElementById('canvas').style.width); },  
 111384: () => { if (document.fullscreenElement) return 1; },  
 111430: () => { return document.getElementById('canvas').width; },  
 111482: () => { return screen.width; },  
 111507: () => { return window.innerWidth; },  
 111533: () => { return window.innerHeight; },  
 111560: () => { if (document.fullscreenElement) return 1; },  
 111606: () => { return document.getElementById('canvas').width; },  
 111658: () => { return screen.width; },  
 111683: () => { document.exitFullscreen(); },  
 111710: () => { if (document.fullscreenElement) return 1; },  
 111756: () => { return document.getElementById('canvas').width; },  
 111808: () => { return parseInt(document.getElementById('canvas').style.width); },  
 111876: () => { document.exitFullscreen(); },  
 111903: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 111961: () => { return screen.width; },  
 111986: () => { return screen.height; },  
 112012: () => { return window.screenX; },  
 112039: () => { return window.screenY; },  
 112066: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 112119: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 112190: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 112247: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 112503: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 112574: () => { if (document.fullscreenElement) return 1; },  
 112620: () => { return window.innerWidth; },  
 112646: () => { return window.innerHeight; },  
 112673: () => { if (document.pointerLockElement) return 1; }
};
